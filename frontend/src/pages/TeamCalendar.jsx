...
export default function TeamCalendar() {
  ...
  return (
    <>
      ...
      <div className="glass-panel p-4 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border border-white/10">
                ...
                <button
                  ...
                  className={`h-20 sm:h-24 rounded-xl p-1.5 text-left border flex flex-col justify-between transition-all duration-150 relative group cursor-pointer ${
                    isSelected
                      ...
                      : isToday
                      ? 'bg-aurora-violet/10 border-aurora-violet/40 text-white'
                      : dayLeaves.length > 0
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="bg-aurora-violet/[0.05] p-3 rounded-xl border border-aurora-violet/20 text-xs text-slate-200 italic leading-relaxed">
